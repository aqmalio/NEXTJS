  ...
  return (
    <>
      ...
      <div className="w-full mt-20 pt-6 px-4 sm:px-6 lg:px-28 flex justify-center flex-col space-x-0 md:space-x-5 p-8">
        ...
        <div className="flex mt-10 flex-col md:flex-row space-x-0 space-y-10 md:space-x-20 md:space-y-0">
      ...
      <div className="w-full mt-20 pt-6 px-4 sm:px-6 lg:px-28 flex justify-center flex-col space-x-0 md:space-x-5 p-8">
        ...
        <div className="w-full flex flex-col mt-10 md:flex-row space-x-0 space-y-10 md:space-x-20 md:space-y-0">
